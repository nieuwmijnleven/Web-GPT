...
3. Use OAuth when prompted. DevSpace exposes protected-resource and authorization-server metadata and supports DCR, PKCE, access tokens, and refresh tokens. Approve the DevSpace owner-password page only for this intended client.
