...
sudo rm -f /etc/systemd/system/openai-mcp-tunnel.service /etc/systemd/system/devspace.service /usr/local/libexec/run-openai-mcp-tunnel /usr/local/libexec/run-devspace
